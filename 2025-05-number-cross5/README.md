...
Running on target board, it takes 3h41m. Actually it finds the same solution twice.
```
...
## Improved single threaded solution

Commit: 7c188b65b237f1823ecbd1ad4c420f8daecdec3b.

```
krzysztof@krzysztof-Latitude-5531:~/moje/programy/janestreet/puzzles(master)$ make && /usr/bin/time 2025-05-number-cross5/number_cross < 2025-05-number-cross5/board.in > 2025-05-number-cross5/board5.out
[ 15%] Built target sudoku
[ 30%] Built target mirrors
[ 61%] Built target number_cross
[ 76%] Built target dynamic_bitset_test
[100%] Built target hints_test
9581.37user 0.07system 2:39:45elapsed 99%CPU (0avgtext+0avgdata 75648maxresident)k
0inputs+26608outputs (0major+18377minor)pagefaults 0swaps
krzysztof@krzysztof-Latitude-5531:~/moje/programy/janestreet/puzzles(master)$ grep -A 17 "Found solution" 2025-05-number-cross5/board5.out
Found solution:
Grid:
 0 + X 3 4 2 2 2 5 X 3 2 4
 1 + 5 4 X 2 2 5 X 2 5 2 X
 2 + X 5 3 4 3 X 6 5 X 2 6
 3 + 7 3 6 X 3 2 X 5 4 4 X
 4 + X 5 5 5 X 2 2 X 8 1 6
 5 + 5 5 X 5 5 1 X 1 5 5 X
 6 + X 3 6 7 4 4 1 2 X 1 5
 7 + 7 3 7 X 9 6 9 X 9 9 X
 8 + 3 4 X 4 6 3 6 8 X 8 9
 9 + 5 3 5 9 3 X 5 9 9 5 X
10 + X 4 7 X 8 8 7 X 4 3 3
